...
class RegistrationPageForDoc extends StatefulWidget {
  const RegistrationPageForDoc({Key? key}) : super(key: key);
...
///////////////////////////////////nassim stuff for clickdoc in new user
        await FirebaseFirestore.instance
            .collection('Docuser')
            .get()
            .then((value) => value.docs.forEach((element) {// yfot 3la ga3 liste t3 doctors yjib id t3hom 'element.id'
